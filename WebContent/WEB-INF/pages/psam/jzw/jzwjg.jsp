...
<input id="jzwjgId" type="hidden" value="${jzwjgId}">
	<div data-options="region:'west',title:'建筑物信息',split:true" style="width: 175px;">
		<div class="easyui-layout" data-options="fit:true">
			<div data-options="region:'north',border:false,collapsible:false" style="height: 340px;">
				<div style="height: 20px;text-align: center;">&nbsp;</div>
				<div  id="jzwjgInfo" style="height: 60px;text-align: center;" >
				建筑物详细信息
				</div>
				...
				<div>
				<a href="javascript:void(0)" onclick="openBigPic('jg');" class="easyui-linkbutton">照片管理</a>
				</div>
				<br />
			...
			<div data-options="region:'center',title:'房间信息',split:true"  style="width: 220px;">
				<div style="height: 20px;text-align: center;">&nbsp;</div>
				<div id="jzwfjInfo" style="height: 60px;text-align: center;"  >
					房间详细信息
				</div>
				...
				<div style="height: 20px;text-align: center;"> 
				  <div>
				   <a href="javascript:void(0)" onclick="openBigPic('fj');" class="easyui-linkbutton">照片管理</a>&nbsp;
				  </div>
				  <br />
...
<div id="dlg_picShow" class="easyui-dialog" data-options="modal:true" style="width: 960px; height: 720px; padding: 10px 10px" closed="true">
		<img style="" id="bigPicShow" alt="显示图片" width="900px" height="580px" src="" >	
		<br>
<button class="btn btn-default" onclick="picDelete();">删除照片</button>
&nbsp;&nbsp;
<button id="ctlBtn" class="btn btn-default" >开始上传 </button>
&nbsp;&nbsp;
<span style="color: red;">(照片格式gif,jpg,jpeg,bmp,png)</span>
<hr/>
<div id="uploader" >
...
<div data-options="region:'center',border:false">
	<div class="easyui-layout" data-options="fit:true">
		<div data-options="region:'north',border:false" style="height: 40px;overflow: hidden;"  >
			<div class="easyui-panel" style="height:40px;padding:5px;border-width: 0px;margin: 0px;width: 830px;" >
				<input id="jzwjgId" type="hidden" value="${jzwjgId}">
			...
			<km:widgetTag widgetRulevalue="syfwrk.saveRkInfoAccInfo">	
				...
				<a href="#" class="easyui-linkbutton" iconCls="icon-kmedit" plain="true" onclick="insertDwxx()">单位信息采集</a>
...
<div data-options="region:'east',border:true,title:'功能区',collapsed:false" style="width: 180px;"  >
	<!-- 	<div class="easyui-layout" data-options="fit:true">
...
function insertDwxx(){
	window.frames["jzwjgIframe"].insertDwxx();
}
//----------------------------------------------------------------
function initRktree(){
	$('#tt').tree({
		...
		data:[{
			...
			"children":[{
				...
				/* ,{
					"id":"/psam/sy/syfwCzrk/loadZdrkFj",
					"valuex":"zdrk",
					"text":"重点人口",
					"checked":true  
				} */]
				...
				"text":"单位管理",
				"children":[{
					"id":"/psam/dwxx/loadDwxxFj",
					"valuex":"dwxx",
					"iconCls":"icon-add",
					"text":"单位基本信息",
					"checked":true  
				},{
					"id":"/psam/dwxx/loadDwxxFjForLb?table_value=jxcs",
					"valuex":"dwxx",
					"iconCls":"icon-add",
					"text":"九小场所管理",
					"checked":true  
				},{
					"id":"/psam/dwxx/loadDwxxFjForLb?table_value=ylfwcs",
					"valuex":"dwxx",
					"iconCls":"icon-add",
					"text":"娱乐服务场所",
					"checked":true  
				},{
					"id":"/psam/dwxx/loadDwxxFjForLb?table_value=qtggcs",
					"valuex":"dwxx",
					"iconCls":"icon-add",
					"text":"其他公共场所",
					"checked":true  
				},{
					"id":"/psam/dwxx/loadDwxxFjForLb?table_value=zddw",
					"valuex":"dwxx",
					"iconCls":"icon-add",
					"text":"重点单位",
					"checked":true  
				},{
					"id":"/psam/dwxx/loadDwxxFjForLb?table_value=tzhy",
					"valuex":"dwxx",
					"iconCls":"icon-add",
					"text":"特种行业",
					"checked":true  
				},{
					"id":"/psam/dwxx/loadDwxxFjForLb?table_value=bafwgs",
					"valuex":"dwxx",
					"iconCls":"icon-add",
					"text":"保安服务公司",
					"checked":true  
...
$(function(){
	...
	initRktree();
	loadMask.open();
	setTimeout(function(){loadjzwinfo();}, 1000);
});
//-------------------------------------------------------------------------------------------
...
function loadJzwPic(flag){
   ...
   if(jzwjgPicIds==null||jzwjgPicIds==""||jzwjgPicIds==undefined||jzwjgPicIds.length==0){
	   imageUrl=ctx+"/static/images/nopic.png";
    }else{
...
function loadJzwFjPic(flag){
	...
	var imageUrl;
	if(jzwfjPicIds==null||jzwfjPicIds==""||jzwfjPicIds==undefined||jzwfjPicIds.length==0){
		 imageUrl=ctx+"/static/images/nopic.png";
	}else{
	...
	if("fj"==jgOrfj){
		...
		picId=jzwfjPicIds[jzwfjPicIndex];
		 if(picId==null||picId==""||picId==undefined){
			 bigImageUrl=ctx+"/static/images/nopic.png"
		 }else{

	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 10px;">
		<form id="fm" method="post" action="${ctx}/psam/fw/updateOrAddFW">
		 <input type="hidden" name="fwid" value="${fw.fwid}"/>
			<fieldset>
				<legend><img src="static/images/fromedit.png" style="margin-bottom: -3px;"/>房屋基本信息编辑</legend>
				 <table id="formTbale" cellpadding="4">
					  <tr>
						...
						<th>房屋类型</th>
						<td>
							<input id="fwlx" dict="fwlxDict" name="fwlx" value="${fw.fwlx}" class="form-control" data-options="editable:false" style="width:173px;"/>
						</td>
					    <th>房屋产权证号</th>
					 ...
					 <tr>
						...
						<th>房主联系电话</th>
						<td><input type="text" name="fzlxdh" value="${fw.fzlxdh}"  class="easyui-numberbox easyui-validatebox form-control" data-options="required:true,validType:'length[1,100]'" style="width:173px;"/></td>
					</tr>
					 <tr>
					   	<th>托管人姓名</th>
						...
						<th>托管人联系电话</th>
						<td><input type="text" name="tgrlxdh" value="${fw.tgrlxdh}"  class="easyui-numberbox easyui-validatebox form-control" data-options="required:true,validType:'length[1,100]'" style="width:173px;"/></td>
					</tr>
					<tr>
					    <th>房主关系</th>
					    <td><input dict="rygxDict" name="yfzgx"  value="${fw.yfzgx}"  class="form-control" data-options="editable:false"  style="width: 170px;"/></td>
					<%-- 	<td><input type="text" name="yfzgx" value="${fw.yfzgx}"  class="easyui-textbox easyui-validatebox form-control" data-options="required:true,validType:'length[1,100]'" /></td> --%>
						<th>是否出租房屋</th>
						<td colspan="3">
							<select id="sfczfw" name="sfczfw"  class="easyui-combobox" style="width: 170px;" data-options="editable:false">
					 ...
					 <tr>
					    <th>房屋类别</th>
						<td>
							<input id="fwlb" dict="fwlbDict" name="fwlb" value="${fw.fwlb}" class="form-control" data-options="editable:false" style="width:173px;"/>
						</td>
						<th>房屋性质</th>
						<td>
							<input id="fwxz" dict="fwxzDict" name="fwxz" value="${fw.fwxz}" class="form-control" data-options="editable:false" style="width:173px;"/>
						</td>
						<th>房屋用途</th>
						<td>
							<input id="fwyt" dict="fwytDict" name="fwyt" value="${fw.fwyt}" class="form-control" data-options="editable:false" style="width:173px;"/>
						</td>
					 </tr>
					 <tr>
					    <th>户型(*室*厅)</th>
						...
						<th>房屋间数</th>
						<td><input type="text" name="fwjs" value="${fw.fwjs}"  class="easyui-numberbox easyui-validatebox form-control" data-options="required:true,validType:'length[1,100]'" style="width:173px;" /></td>
						<th>房屋面积(平米)</th>
						<td><input type="text" name="fwmj" value="${fw.fwmj}"  class="easyui-numberbox easyui-validatebox form-control" data-options="required:true,validType:'length[1,100]'" style="width:173px;" /></td>
					 </tr>
				 </table>
			</fieldset>

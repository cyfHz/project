		...
		<div class="easyui-layout" data-options="fit:true">
		   <div data-options="region:'north',border:false" style="height: 50px; background-color: #F4F4F4;">
					...
					<div class="form-group">
						<label>乡镇街道名称:</label> 
						<input type="text" name="webParams['xzjdmc']" class="easyui-textbox" style="height:21px;"/>
					</div>
					<div class="form-group">
						<label>乡镇街道代码:</label>
						<input type="text" name="webParams['xzjddm']" class="easyui-numberbox" style="height:21px;"/>
					...
					<div class="form-group">
					<km:widgetTag widgetRulevalue="xzjd.loadXzjdGridView">
	    ...
	    $("#xzjdDataGrid").datagrid({
				    ...
				    rowStyler:function(index,row){
				    	if(row.SYZTDM==20||row.SYZTDM==40){
				    		return 'color: #5e5e5e;background-color: #E4E4E4;text-decoration: line-through;'
				    		}
				    	},
...
//---------------------------------------------------------------------
 function openeditDialog(){
    ...
    var options={title:"乡镇街道信息编辑页面",width:1000,height:400, url:url,params:param,onClosed:function(){loaddata('reload');}};
	editDialog.open(options);
	//alertMsg.info("打开编辑页面");
 }
 function openAddDialog(){
    var url="${ctx}/psam/xzjd/enterAddXzjd";
	var options={title:"乡镇街道信息添加页面",width:1000,height:400, url:url,params:{},onClosed:function(){loaddata('reload');}};
	editDialog.open(options);
}
 function openDetailDialog(){
	 var rows = $("#xzjdDataGrid").datagrid("getSelections");
		...
		var param={dzbm:rows[0].DZBM};
	    var options={title:"乡镇街道详细信息",width:800,height:400, url:url,params:param,onClosed:function(){loaddata('reload');}};
		editDialog.open(options);
}

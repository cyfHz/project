...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false " title="" style="overflow: hidden;padding: 10px;">
		...
		<form id="formss" method="post" action="${ctx}/psam/jlx/revokeJlx">
		
		 <input type="hidden" name="dzbm" value="${jlx.dzbm}"/>
		 
			<fieldset>
				<legend><img src="static/images/fromedit.png" style="margin-bottom: -3px;"/>街路巷（小区）撤销原因填写</legend>
				 <table>
					 <tr>
					    <th>撤销原因</th>
						<td>
						<textarea id="CXYY" name="cxyy" value="" class="easyui-validatebox" data-options=" required:true, validType:'length[0,50]'" style="height:80px; width:600px">${jlx.cxyy}</textarea>
						</td>
					 </tr>
				 </table>
			</fieldset>

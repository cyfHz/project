...
<div data-options="region:'center',border:false" style="width: 650px;height: 100%">
    <div id="fj_container" style="min-width:600px; width: 600px; min-height:760px;"></div>
</div>
<div data-options="region:'east',border:false" style="width: 600px;">
    <div id="fj_containerpie" style="min-width: 600px; height: 760px; "></div>
</div>
<input type="hidden" id="sjName" value="${sjName}">
...
function initDataSatistic(){
	var ajaxUrl="${ctx}/psam/dataStatistic/loadFjStatisticData";
	var param = {"sjName":$("#sjName").val()};

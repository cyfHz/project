...
<body class="easyui-layout">
            ...
            <table id="logDataGrid" data-options="fit:true" ></table>
...
//--------------------------基本逻辑---------------------------------------------------
   $(function() {
    ...
    function initDataGrid(){
    	var loadurl="${ctx}/common/log/log/loadLogDataGrid";
    	  treeDrid = $("#logDataGrid").datagrid({
				title:"系统日志管理",
				...
				columns:[[
					...
					{field:'USER_LOGINNAME',title:'用户名',width:100,sortable:true},
					{field:'ORGNA_ID',title:'组织机构ID',width:110},
					{field:'LOG_TYPE',title:'日志类型',width:110},
					{field:'LOG_OBJECT',title:'LOG_OBJECT',width:110},
					{field:'LOG_CONTENT',title:'LOG_CONTENT',width:110},
					{field:'AREA_CODE',title:'领域',width:110},
					{field:'OPRATETIME',title:'操作时间',width:110},
					{field:'OPERATE_URL',title:'请求地址',width:110}
				]],

 ...
 */
@Service
public class SyRkglLdrkdjbServiceImpl extends BaseService implements ISyRkglLdrkdjbService {
	@Autowired
	...
	public DataSet loadSyLdrkDataSet(Map<String, String> params) {
		...
		if(dataAuth!=null && !dataAuth.isEmpty()){
			params.put("ssjwq",  dataAuth + "%");
		}
		return new DataSet(syRkglLdrkdjbMapper.selectSyLdrkCount(params), syRkglLdrkdjbMapper.selectSyLdrklist(params));
	...
	public SyRkglLdrkdjb loadSyLdrkDeatil(String ldid) {
		if(ldid==null||"".equals(ldid)){
			throw new ServiceLogicalException("请选择要查看流动人员信息");
		}
		SyRkglLdrkdjb ldrk=syRkglLdrkdjbMapper.selectByPrimaryKey(ldid);
		if(ldrk==null){
			throw new ServiceLogicalException("流动人口信息为空");
		}
		return ldrk;
	}

	@Override
	public void updateSyLdrkAccInfo(SyRkglLdrkdjb ldrk,byte[] imgFile) {
		...
		Date date=new Date();
		SyRkglLdrkdjbPic picInfo=syRkglLdrkdjbPicMapper.selectNotNullPicInfoByZjhm(ldrk.getSfzh());
		//处理照片
...
//					do nothing
		...
		syRkglLdrkdjbMapper.updateByPrimaryKeySelective(ldrk);
	}
	...
	public DataSet loadSyLdrkDataSet(String jzwfjid) {
		...
		.append(" ld.XJZDZZ, ")
		.append(" ld.XJZDZZFJH ");
		sql.append(" @from SY_RKGL_LDRKDJB ld ");
		sql.append(" where 1=1 ");
		if(!SubApStrUtil.isEmptyAfterTrimE(jzwfjid)){
			sql.append(" and ld.FJBM=:jzwfjid ");
	...
	public void cancelLdrk(String id) {
		// TODO Auto-generated method stub
		   ...
		   map.put("ldid",id);
		   map.put("zxsj",nowDate);
		   map.put("zxbz", flag);
		   syRkglLdrkdjbMapper.cancelLdrk(map);
	...
	public void activatesyLdrk(String id) {
		// TODO Auto-generated method stub
		   ...
		   map.put("zxsj",nowDate);
		   map.put("zxbz", flag);
		   syRkglLdrkdjbMapper.activatesyLdrk(map);
	}
	...
	public List<SyRkglLdrkdjb> selectSyLdrkInfoByJzwfjId(String jzwfjid) {
		...
		List<SyRkglLdrkdjb> ldrklist=syRkglLdrkdjbMapper.selectSyLdrkInfoByJzwfjId(jzwfjid);
		return ldrklist;
	}
	...
	public List<SyRkglLdrkdjb> selectSyLdrkInfoByJzwfjIdKey(String jzwfjid) {
		...
		List<SyRkglLdrkdjb> ldrklist=syRkglLdrkdjbMapper.selectSyLdrkInfoByJzwfjIdKey(jzwfjid);
		return ldrklist;
	}
	...
	public List<SyRkglLdrkdjb> selectSyLdrkInfoFwByJzwfjIdKey(String jzwfjid) {
		...
		List<SyRkglLdrkdjb> ldrklist=syRkglLdrkdjbMapper.selectSyLdrkInfoFwByJzwfjIdKey(jzwfjid);
		return ldrklist;
	}
	...
	public SyRkglLdrkdjb selectLdrkInfoByZjbh(String sfzh) {
		...
		return syRkglLdrkdjbMapper.selectglldrkById(sfzh);
	}
	/**
	 * 
	 * @param sfzh
...
//		strReturns.put("XP","");
		if (strReturns != null) {
			...
			if(strReturns.get("XP")!=null && !("".equals(strReturns.get("XP")))){
				SyRkglLdrkdjbPic picInfo=syRkglLdrkdjbPicMapper.selectPicInfoByZjhm(sfzh);
	...
	public long loadldrkWorkCount(Map<String, Object> map) {
		// TODO Auto-generated method stub
		return syRkglLdrkdjbMapper.loadldrkWorkCount(map);
	}

	@Override
	public List<Map<String, Object>> loadTodayWorkDetail(Map<String, Object> map) {
		// TODO Auto-generated method stub
		return syRkglLdrkdjbMapper.selectSyLdrkWorkDetail(map);
	}
...
//---------------------------------------------
    ...
    public DataSet selectSyLdrkForFw(Map<String, String> map){
		...
		DataSet ds = new DataSet(syRkglLdrkdjbMapper.selectSyLdrkForFwCount(map), syRkglLdrkdjbMapper.selectSyLdrkForFw(map));
		return ds;
    }
	...
	public DataSet selectSyLdrkForFwLsry(Map<String, String> map){
    	...
    	PaginationUtil.initPageAndSort(map);
		DataSet ds = new DataSet(syRkglLdrkdjbMapper.selectSyLdrkForFwLsryCount(map), syRkglLdrkdjbMapper.selectSyLdrkForFwLsry(map));
		return ds;
	}
